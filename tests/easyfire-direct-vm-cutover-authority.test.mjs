...
test('collector output from validated machine receipts passes the cutover contract', () => {
  ...
  const rehearsalEvidence = rehearsalContract.buildRehearsalEvidence({
    ...
    normalReboot: { markerSha256: digest('1'), proofSha256: digest('2'), bootIdBefore: '53682154-c88d-48ee-9194-adac4790d8cc', bootIdAfter: '71129d5d-51c2-4599-9b9e-72a649d1eef2', completedAt: '2026-07-21T18:57:00.000Z', stackAuthorityVerified: true, guardianTimerActive: true, guardianTimerEnabled: true, guardianCurrentBoot: { timerActiveState: 'active', timerSubState: 'waiting', timerUnitFileState: 'enabled', timerLastTriggerMonotonicUsec: '120000000', timerNextElapseMonotonicUsec: '150000000', serviceActiveState: 'inactive', serviceSubState: 'dead', serviceResult: 'success', serviceExecMainCode: 1, serviceExecMainStatus: 0, serviceStartedMonotonicUsec: '121000000', serviceExitedMonotonicUsec: '122000000', serviceInvocationId: 'a'.repeat(32), journalBootId: '71129d5d51c245999b9e72a649d1eef2', journalMessageSha256: digest('3'), statusSha256: digest('4'), statusObservedAt: '2026-07-21T18:56:00.000Z', statusPhase: 'healthy', statusHealthy: true, rebootMarkerPreparedAt: '2026-07-21T18:50:00.000Z' } },
